...
# Load data
top_folder = "/Users/DTH/Library/Mobile Documents/com~apple~CloudDocs/DTU/02582 - Computational Data Analysis/Case 2/CDA_Case2/online_rep/data/"
...
print("Foggy pics:",len(foggy_im))
print("Clear pics:",len(clear_im))
print("Other pics:",len(net_im))
